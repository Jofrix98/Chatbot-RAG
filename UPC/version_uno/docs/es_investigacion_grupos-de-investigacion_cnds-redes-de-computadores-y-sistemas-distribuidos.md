...
Investigación](/es/investigacion/grupos-de-investigacion) » CNDS - Redes de
...
subgrupos: [Statistical Analysis of Networks and Systems
(SANS)](http://sans.ac.upc.edu/) y [Distributed Systems Group
(DSG)](http://dsg.ac.upc.edu/node/607).
...
Web  <http://research.ac.upc.es/cnds/>

## Producción científica

Da un vistazo a la página web de la producción científica de la investigación
de la UPC: [futur.upc.edu](http://futur.upc.edu/CNDS?locale=es)
